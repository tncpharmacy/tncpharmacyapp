...
export default function DoctorProfile() {
  const [formData, setFormData] = useState({
    ...
    speciality: "MBBS – Bachelor of Medicine, Bachelor of Surgery",
    experiance: "8",
    licNo: "123456ASD",
    registrationCouncil: "1234578",
    registrationYear: "2000",
    mobile: "7894561234",
    whatsappNo: "7894561234",
    email: "abc@xyz.com",
    consultationFee: "500",
    videoConsultationFee: "400",
    audioConsultationFee: "200",
    professionalSummary:
      "A professional summary, also known as a resume summary, is a concise overview of your skills, experience, and achievements, typically placed at the top of your resume.",
  });
  return (
    <>
      <Header />
