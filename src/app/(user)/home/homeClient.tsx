...
export default function HomeClient({
  ...
  const [groupCare, setGroupCare] = useState(initialGroupCare || []);
  ...
  //   const medicineMenuByCategory5 = initialCategory5 || [];
  //   const medicineMenuByCategory7 = initialCategory7 || [];
  //   const medicineMenuByCategory9 = initialCategory9 || [];
