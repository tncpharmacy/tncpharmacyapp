...
export default function MedicineImagesBulkDownload() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const payload = excelData
        ...
        .filter((item) => item.url && item.medicine_code);
        ...
        <div className="body_right">
          <div className="body_content">
            <div className="pageTitle">
              <i className="bi bi-file-earmark-arrow-down"></i> Medicine Images
              Bulk Download
            </div>
              ...
              <div className="row gy-3">
                ...
                <div className="col-md-6">
                  <button className="btn-style1 w-100" onClick={handleSubmit}>
                    <i className="bi bi-check2-circle"></i> Final Download
                  </button>
                </div>
              </div>
