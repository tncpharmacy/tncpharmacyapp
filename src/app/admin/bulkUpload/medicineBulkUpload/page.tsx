...
export default function MedicineBulkUpload() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await api.post(API_ENDPOINTS.UPLOAD_MEDICINE, formData, {
        headers: {
        ...
        <div className="body_right">
          <div className="body_content">
            <div className="pageTitle">
              <i className="bi bi-file-earmark-arrow-up"></i> Medicine Bulk
              Upload
            </div>
