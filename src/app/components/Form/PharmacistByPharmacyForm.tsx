...
import "@/app/pharmacy/css/style.css";
import {
  createPharmacistApi,
  updatePharmacistApi,
...
import { fetchPharmacist } from "@/lib/features/pharmacistByPharmacySlice/pharmacistByPharmacySlice";
...
export default function PharmacistByPharmacyForm({ id }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    formDataToSend.append("pharmacy_id", String(userId));
    ...
    try {
      if (id) {
        ...
        router.push("/pharmacy/pharmacist");
      } else {
