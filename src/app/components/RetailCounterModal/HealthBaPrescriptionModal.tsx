// app/components/RetailCounterModal/HealthBagPrescriptionModal.tsx

import React from "react";
import { Modal, Button, Table } from "react-bootstrap";

interface HealthBagPrescriptionModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const HealthBagPrescriptionModal: React.FC<HealthBagPrescriptionModalProps> = ({
  isOpen,
  onClose,
  cartItems,
  onProceed,
...
export default HealthBagPrescriptionModal;
