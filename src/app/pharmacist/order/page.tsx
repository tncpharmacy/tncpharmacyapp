...
export default function OrderList() {
  ...
  const buyers = [
    { id: 11, name: "Pulkit Srivastava" },
    { id: 5, name: "Ravi Sharma" },
    { id: 10, name: "Sunita Devi" },
  ];
  useEffect(() => {
  ...
  const handleBuyerChange = (e: React.ChangeEvent<HTMLSelectElement>) => {
    ...
    const buyerId = Number(value); // convert string → number
        ...
        <div className="body_right">
          <div className="body_content">
            <div className="row align-items-center justify-content-between mb-3">
              <div className="pageTitle col-sm-6 text-start">
                ...
                <div className="row">
                  ...
                  <div className="col-md-3">
                    <div className="txt_col">
                      <span className="lbl1">Select Buyer</span>
                      <select
                        className="txt1"
                        value={selectedBuyer}
